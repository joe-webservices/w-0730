...
const ProjectCard = ({ title, imageSrc }: { title: string; imageSrc: string }) => {
  return (
    <div className="bg-adam-gray rounded-lg overflow-hidden">
...
const Chat = () => {
  ...
  const featuredProjects = [
    { title: 'Jewelry Holder', imageSrc: '/lovable-uploads/af99a164-9ee9-4a6f-8b0a-947e590f5f3e.png' },
    { title: 'Laptop Stand', imageSrc: 'https://placehold.co/200x150/222/44aaff/png' },
    { title: 'Candle Stand', imageSrc: 'https://placehold.co/200x150/222/ff44aa/png' },
    { title: 'LEGO Brick', imageSrc: 'https://placehold.co/200x150/222/ff6644/png' },
    { title: 'Shelf Bracket', imageSrc: 'https://placehold.co/200x150/222/ff44aa/png' },
    { title: 'Propeller Blade', imageSrc: 'https://placehold.co/200x150/222/ffaa44/png' },
    { title: 'Ergonomic Spatula', imageSrc: 'https://placehold.co/200x150/222/44ff66/png' },
    { title: 'Wall-Mounted key holder', imageSrc: 'https://placehold.co/200x150/222/ffdd44/png' },
    { title: 'Toothbrush holder', imageSrc: 'https://placehold.co/200x150/222/44ddff/png' },
    { title: 'Stamp', imageSrc: 'https://placehold.co/200x150/222/44ddff/png' },
    { title: 'Basic Phone Stand', imageSrc: 'https://placehold.co/200x150/222/ff4444/png' },
    { title: 'Pencil Holder', imageSrc: 'https://placehold.co/200x150/222/44ff44/png' },
  ];
      ...
      <div className="w-[192px] bg-adam-darker border-r border-white/10 flex flex-col">
        <div className="p-4">
          <Link to="/" className="block mb-4">
            <img 
              src="/lovable-uploads/af99a164-9ee9-4a6f-8b0a-947e590f5f3e.png" 
              alt="Adam Logo"
              className="h-8"
            />
          </Link>
